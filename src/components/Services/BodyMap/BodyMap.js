...
const BodyMap = () => {
  return(
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="dashboard.php"> <img src="../../assets/img/logo.png" alt="logo"/> </a>
      ...
      <Navbar/>
        ...
        <div className="ms-content-wrapper">
            ...
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active">Body map <Link class="btn btn-primary" to="/create_bodymap" Style="float:right; margin-top:0px;">Create New</Link></li>
            </ol>
          </nav>
            ...
            <div class="ms-panel">
                                ...
                                <div class="col-sm-12" Style="padding: 0px 0px 0px 15px;">
                                    <div class="tab_menus" Style="float:left;">
                                        <ul>
                                            ...
                                            <li class="active"><Link to="/bodymap" class="active">Active</Link></li>
               ...
               <div class="col-md-12">
                        ...
                        <div class="col-md-3 text-center">
                            {/* <!--<h5>Front</h5>--> */}
                            <img src="../../assets/img/frontbody.png" Style="width:100%"/>
                         {/* <!--<span class="dott1" Style="position: absolute; right: 51%;top: 23%;"></span>--> */}
                         </div>
                          
                           
                         <div class="col-md-3 text-center">
                               {/* <!--<h5>Back</h5>--> */}
                             <img src="../../assets/img/backbody.png" Style="width:100%"/>
